...
public final class TebexFoliaPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getGlobalRegionScheduler().runAtFixedRate(this, task -> platform.refreshListings(), 1, 5 * 60 * 20);

        // Every 10 minutes clear the plugin event queue
        getServer().getGlobalRegionScheduler().runAtFixedRate(this, task -> platform.getSDK().sendPluginEvents(), 1, 60 * 20 * 10);
